...
const AddSubCategory = () => {
  ...
  return ( 
    <>
   {
    showModal && <SubCategoryModal setShowModal={setShowModal}  setfetchSubCategory={ setfetchSubCategory}/>
   }
     ...
     <div className="grid grid-cols-3 gap-3 px-2 py-3 md:px-6">
      {
          subcategory?.map(subcategory => (
            <div>
            <SubcategoryCardComponent subcategory={subcategory} setEdit={setEdit}/>
            </div>
          ))
      }   
    </div>
