    ...
    <>
      ...
      <div className="grid grid-cols-8">
        ...
        <div className="col-span-6 md:col-span-2">
          <form className="rounded-md px-2 md:px-6 py-6 md:py-12 shadow-xl bg-white" onSubmit={userDetailSubmitHandler}>
     `  <div className='px-6 text-center'> 
            ...
            <div className='flex flex-col items-center'>
              <span className='text-[#B3B3B3] text-[0.6rem] font-normal text-center'>
        By continuing, I agree to the <span className="font-[600] text-black">Terms of Use</span> & <span className="font-[600] text-black">Privacy Policy</span>
              </span>

              <button className={`font-normal  bg-[#800080] text-[white] rounded-md w-full py-3 px-6 my-6 
${disabled ? "cursor-not-allowed opacity-50" : "cursor-pointer opacity-100"} `}>Login</button>

              <span className='text-[#B3B3B3] text-[12px] font-normal text-center cursor-pointer' onClick={()=>navigateToSignUp()}>Dont have an account?
