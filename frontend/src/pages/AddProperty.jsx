...
const AddProperty = () => {
  ...
  return (
    <> 
      ...
      {
        limit ? <>
          <div className='flex flex-col px-0 md:px-6 md:mt-0 justify-center items-center h-screen 
          flex-wrap'>
 ...
 text-[16px] font-normal mb-2">To increase your limit, please contact system admin</p>
              <p className="block tracking-wide text-[#464646]
 text-[16px] font-normal mb-2">Email - test@test.com</p>
              <p className="block tracking-wide text-[#464646]
 text-[16px] font-normal mb-2">Ph number- 9278287878</p>
              <button type="button" onClick={()=> setLimit(false)} 
                className="font-normal  bg-green-400 text-[white] flex items-center 
              rounded-md py-2 my-6 text-[13px] px-3 cursor-pointer opacity-100 w-14">Back</button>
            </div>
          </div>
        </>:  
