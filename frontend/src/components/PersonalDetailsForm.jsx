...
const PersonalDetailsForm = ({setActivateFirstProperty,setActivateFirstPropertyStepper}) => {
  ...
  return (
    <>
      <div className='flex flex-col px-6' style={{
        ...
        <form className="rounded-md px-2 md:px-6 py-6 shadow-xl bg-white" onSubmit={userDetailSubmitHandler}>
          ...
          <div className="flex flex-col mb-6">
            ...
            focus:shadow-lg focus:shadow-[#800080]-500/50 focus:border-2 focus:border-[#800080]
             w-full h-[42px]
             rounded-md  px-4 mb-3 leading-tight focus:outline-none" required
              id="grid-first-name" type="text" placeholder="" 
          ...
          <div className='flex flex-col items-center'>
            ...
            <button
              className={`font-normal bg-[#800080] text-[white] rounded-md w-full py-3 px-6 my-6 ${
                (disabled || !captchaToken) ? "cursor-not-allowed opacity-50" : "cursor-pointer opacity-100"
              }`}
