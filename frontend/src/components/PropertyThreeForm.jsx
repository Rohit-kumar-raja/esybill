...
const PropertyThreeForm = ({
  ...
  useEffect(() => {
    if (propertyDetails.length > 2) {
      setPropType(propertyDetails[2].PropType);
      setPropName(propertyDetails[2].PropName);
      setPropEmail(propertyDetails[2].PropEmail);
      setPropAddress(propertyDetails[2].PropAddress);
      setPropPhone(propertyDetails[2].PropPhone);
      setPropState(propertyDetails[2].PropState);
      setPropCountry(propertyDetails[2].PropCountry);
    }
  }, [
    ...
    <>
      ...
      <div className="flex flex-col px-6">
        <form
          ...
          onSubmit={propertyThreeSubmitHandler}
        >
