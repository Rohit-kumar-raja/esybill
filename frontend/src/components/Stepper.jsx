  ...
  return ( 
    ...
    "   role="presentation"
        ...
        `}></div>
         ...
         cursor-pointer
          ${activateFirstPropertyStepper ? "opacity-1"  : "opacity-0"}
         `}   onClick={moveToPropertyOneToggleHandler}  role="presentation">02</span>
                <div className={`h-[70px] w-1   bg-[#800080]
          ${activateSecondPropertyStepper ? "opacity-1"  : "opacity-0"}
          `}>
                </div>
         ...
         cursor-pointer ${activateSecondPropertyStepper? "opacity-1"  : "opacity-0"}
          `} 
                onClick={moveToPropertyTwoToggleHandler}  role="presentation">03</span>
                <div className={`h-[70px] w-1  bg-[#800080]
          ${activateThirdPropertyStepper ? "opacity-1"  : "opacity-0"}
          `}></div>
              </div>
          ...
          ${activateThirdPropertyStepper ? "opacity-1"  : "opacity-0"}
          `} 
                onClick={moveToPropertyThreeToggleHandler}  role="presentation">04</span>
                <div className={`h-[70px] w-1 bg-[#800080]
          ${activateFourthPropertyStepper ? "opacity-1"  : "opacity-0"}
          `}></div>
              </div>
          ...
          ${activateFourthPropertyStepper ? "opacity-1"  : "opacity-0"}
           `} 
                onClick={moveToPropertyFourToggleHandler}  role="presentation">05</span>
                <div className={`h-[70px] w-1  bg-[#800080]
          ${activateFourthPropertyStepper ? "opacity-1"  : "opacity-0"}
           `}>
                </div>
