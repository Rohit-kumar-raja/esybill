    ...
    <>
     ...
     flex flex-wrap my-10 md:ml-10 px-10 md:px-0 font-poppins'>What makes us, <span className='text-[#7E007E] font-bold mx-1'>EzyBill India,</span> Stand Out?</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 z-10 relative px-10 ">
          <div className="overflow-y-scroll h-[33rem] col-span-1 md:col-span-2 my-6 md:my-2">
            <div className="flex flex-col">
              <div className="grid grid-cols-1 md:grid-cols-2 z-10 relative md:px-10 md:my-12 ">
                <div >
     ...
     "     />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 md:px-10 md:my-12">
                <div>
