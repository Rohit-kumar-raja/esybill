    ...
    <div className="font-poppins">
      <div className="relative max-w-xs overflow-hidden bg-cover rounded-md p-4 
        ...
        <img
          ...
          alt="Louvre" />
        <div
          className="absolute bottom-0 left-0 right-0 top-0 h-full w-full text-[#FFFFFF] text-[15px]
        overflow-hidden bg-[#C77DCE] bg-fixed opacity-0 transition duration-300 ease-in-out 
        hover:opacity-90 hover:cursor-pointer font-medium flex justify-center items-center px-10">
          {hoverText}
        </div>
      </div>
      <p className='text-[#7E007E] font-bold text-[17px] py-2 '>{title}</p>
    </div>
  )
}
